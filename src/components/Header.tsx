      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 py-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 bg-gradient-to-r from-purple-900 to-blue-900 rounded-2xl p-8 text-white text-center">
            ...
            <button 
              className="bg-yellow-500 text-black px-8 py-4 rounded-xl font-bold hover:bg-yellow-400 transition-colors transform hover:scale-105"
              onClick={() => handleError(new Error('Daily challenges coming soon!'))}
            >
