...
export const danielChapters: ScriptureChapter[] = [
  {
    ...
    content: `**In the third year of the reign of Jehoiakim king of Judah**
...
**And the prince of the eunuchs said unto Daniel,**
    I fear my lord the king,
        who hath appointed your meat and your drink:
            ...
            then shall ye make me endanger my head
                to the king.
...
**Now at the end of the days**
    ...
    then the prince of the eunuchs brought them in
...
**And Daniel continued**
  ...
  },
  {
    ...
    content: `**And in the second year of the reign of Nebuchadnezzar**
...
**Then Daniel requested of the king,**
    and he set Shadrach, Meshach, and Abed-nego,
  ...
  },
  {
    ...
    content: `**Nebuchadnezzar the king made an image of gold,**
...
**Then Nebuchadnezzar the king sent to gather together**
    the princes, the governors, and the captains,
    the judges, the treasurers, the counsellers,
...
**Then the king promoted Shadrach, Meshach, and Abed-nego,**
  ...
  },
  {
    book: "Daniel",
    chapter: 4,
    title: "Nebuchadnezzar's 2nd Dream and Its Fulfillment as given in his own testimony",
    content: `**Nebuchadnezzar the king,**
...
**I saw in the visions of my head upon my bed,**
    and, behold, a watcher and an holy one
...
**Nevertheless leave the stump of his roots in the earth,**
    ...
    and let it be wet with the dew of heaven,
        and let his portion be with the beasts
...
**Now I Nebuchadnezzar praise and extol and honour**
  ...
  },
  {
    book: "Daniel",
    chapter: 5,
    title: "Belshazzar's abominable Feast - The Handwriting on the Wall with the Judgment/Execution on Babylon",
    content: `**Belshazzar the king made a great feast**
...
**Now the queen by reason of the words**
...
**And Darius the Median took the kingdom,**
  ...
  },
  {
    book: "Daniel",
    chapter: 6,
    title: "Daniel in the Lion's Den - the Third Test(Thou shalt have no other gods before Me)",
...
**All the presidents of the kingdom,**
    the governors, and the princes,
    the counsellers, and the captains,
...
**Then answered they and said before the king,**
    That Daniel, which is of the children
...
**Then the king, when he heard these words,**
    was sore displeased with himself,
        and set his heart on Daniel to deliver him:
            and he laboured till the going down of the sun
                to deliver him.
...
**So this Daniel prospered**
  ...
  },
  {
    book: "Daniel",
    chapter: 7,
    title: "The Four Beasts Vision (Lion, Bear, Leopard, Dreadful/Terrible Beast = Babylon, Medo-Persia, Greece, Rome(Pagan/Papal), respectively) - The 4 Great Kingdoms of World History with more detail added about the Fourth beast's actions",
...
**Hitherto is the end of the matter.**
  ...
  },
  {
    book: "Daniel",
    chapter: 8,
    title: "The Ram (with 2 unequal horns) and Goat (with a notable horn between eyes) Vision",
...
**And he shall confirm the covenant**
  ...
  },
  {
    book: "Daniel",
    chapter: 10,
    title: "Daniel's Final Vision Begins",
...
export const formatScriptureContent = (content: string): string => {
