    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 bg-white rounded-2xl shadow-xl p-8 text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Support In-Depth Studies</h2>
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            Creating comprehensive prophetic studies requires extensive research and theological review. Help us develop more detailed study materials.
          </p>
