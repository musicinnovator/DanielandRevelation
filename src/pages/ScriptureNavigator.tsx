  ...
  // Add complete Daniel chapters 3-12
  {
    ...
    verses: [
      ...
      },
      {
        ...
        keywords: ['princes', 'governors', 'captains', 'dedication'],
        crossReferences: ['Revelation 13:16'],
        sdaCommentary: "Universal enforcement parallels the end-time mark of the beast crisis."
      },
      {
        book: 'daniel',
        chapter: 3,
        ...
        keywords: ['gathered together', 'stood before'],
        crossReferences: ['Revelation 13:8'],
        sdaCommentary: "The gathering represents worldwide compliance with false worship."
      },
      {
        book: 'daniel',
        chapter: 3,
